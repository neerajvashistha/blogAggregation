...
def generate_candidate_keywords(sentence_list, stopword_pattern, min_char_length=2, max_words_length=3):
    phrase_list = []
...
class Rake(object):
    def __init__(self, stop_words_path, min_char_length=4, max_words_length=3, min_keyword_frequency=3):
...
if test:
    ...
    stoppath = "SmartStoplist_mod.txt"  #SMART stoplist misses some of the lower-scoring keywords in Figure 1.5, which means that the top 1/3 cuts off one of the 4.0 score words in Table 1.1
    ...
    rake = Rake("SmartStoplist_mod.txt")
